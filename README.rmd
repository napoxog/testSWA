...
####  TODO: 7.2.2 Add saving of the prediction result
####  DONE: 7.2.3 Add NNET QC tools
####  DONE: 7.3. Linear Models types selection
####  TODO: 7.3.1. Add prediction map dispay with wells
####  TODO: 7.3.2. Group the QC plots as for other methods
...
###   TODO: 30. Tune the hover delay in zoom modal plots
###   TODO: 31. Estimate and print the StD of wells' CP for each class
###   TODO: 32. Add Export format Selection (XYZ/ESRI/ZAMP)
